...
copytosatb2: ; R0 = offset in satb (in items) / R1 = item count / data_ptr
    pha
    phx
    lda LOW_BYTE #satb2
    sta LOW_BYTE <satb_ptr
...
satb2shiftx: ; <R3 = which item to begin with, <R0 = amount, <R1 = 1 increment, 0 decrement, <R2 item count
    pha
    phx
...
satb2shifty: ; <R3 = which item to begin with, <R0 = amount, <R1 = 1 increment, 0 decrement, <R2 item count
    pha
    phx
