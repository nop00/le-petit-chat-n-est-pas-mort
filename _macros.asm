...
loadsprite2: ; vram_ptr = VRAM address to load to, data_ptr = label where the tile is
...
loadsprites2: ; <vram_ptr = VRAM address to load to, <data_ptr = label where the sprites are, <R0 = sprite count
